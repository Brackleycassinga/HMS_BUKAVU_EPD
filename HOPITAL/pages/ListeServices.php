		...
		<div class="col-lg-16">
			<h1 class="page-header" style="color:rgb(90, 100, 211);">
                 Gestion des Malades en ligne <small>  : LES SERVICES </small> 
				  <img src="IMA/ref.png" width="100px" height="80px"/>
             </h1>
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            LISTE DE TOUS LES SERVICES DU NEW HOPE HOSPITAL
                        </div>
                        <div class="panel-body">
                            <div class="row">                                
							 ...
							 <?php
									...
									$sqlSearch=mysql_query("SELECT * FROM Services") or die(mysql_error());
									if (mysql_num_rows($sqlSearch)>0){
										
										echo"<div class='col-lg-12'>                       
												<div class='panel-body'>
													<div class='table-responsive'>
													<center><font style='font-weight:bold; color:green'>VOICI LA LISTE DE TOUS LES SERVICES DEJA ENREGISTRES</font></center>
														<br/>
													<table class='table'>
							...
							<?php
										...
										echo "<div class='col-lg-6'><div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
												<span class='glyphicon glyphicon-remove'></span>
													Aucun service trouvé dans la base de donnée! Veuillez les ajouter</strong>, vérifiez-le et réessayer!!</div></div>";
									}

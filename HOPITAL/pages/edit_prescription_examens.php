...
<script type="text/javascript">
	...
	function CountDown(){
		...
		if(counter > 0){
			...
			location.href = "ModifPrescriptionExamens.php";
		}
	}
		...
		<div class="row">
			<div class="col-lg-16">
				<h1 class="page-header" style="color:rgb(90, 100, 211);">
					 Gestion des Malades en ligne  <small>: MODIFICATION DES PRESCRIPTION DES EXAMENS</small> 
									...
									if(mysql_num_rows($rqt)>0){
										...
										if(mysql_num_rows($res)==0){
												...
												if($del){											
														...
														for ($i=1;$i<=$NbreRes;$i++){
															if(isset($_GET["IdExamen".$i])){
																$j = $i." ---";
																mysql_query("INSERT INTO PrescExamensCompose VALUES ('".$IdPrescription."','".$_GET["IdExamen".$i]."')");
															}
														}
													$message = "<div class='col-lg-12'><div class='alert alert-success alert-dismissable'>
																...
																<span class='glyphicon glyphicon-ok'></span> &nbsp; Modification de la Prescription <strong> N° '".$IdPrescription."'</strong> a été effectué avec succès</center></div></div>";
												}
												else{
											...
											$message = "<div class='col-lg-12'><div class='alert alert-danger alert-dismissable'>
														<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
														<center><img src='IMA/error.png'/><br><br>
														<span class='glyphicon glyphicon-alert'></span>Impossible de modifier, car cette prescription a déjà de resultat!! </center></div></div>";

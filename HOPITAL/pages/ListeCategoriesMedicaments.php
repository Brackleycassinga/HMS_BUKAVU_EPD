	...
	<div class="row">
		<div class="col-lg-16">
			<h1 class="page-header" style="color:rgb(90, 100, 211);">
                 Gestion des Malades en ligne <small>  : LISTE DES CATEGORIES DES MEDICAMENTS </small> 
				  <img src="IMA/catmed.png" width="100px" height="80px"/><img src="IMA/dep.jpg" width="100px" height="80px"/>
             </h1>
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            LISTE DE TOUTES LES CATEGORIES DES MEDICAMENTS DE LA PHARMACIE
                        </div>
                        <div class="panel-body">
                            <div class="row">                                
							 ...
							 <?php
									...
									$sqlSearch=mysql_query("SELECT * FROM CategoriesMed") or die(mysql_error());

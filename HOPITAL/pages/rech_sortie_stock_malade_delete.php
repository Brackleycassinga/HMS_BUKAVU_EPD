	...
	<div class="row">
		<div class="col-lg-16">
			<h1 class="page-header" style="color:rgb(90, 100, 211);">
                 Gestion des Malades en ligne <small>  : SUPPRESSION DE LIVRAISON DE MED. AUX MALADES </small> 
				  <img src="IMA/error.png" width="120px" height="80px"/>
             </h1>
                    <div class="panel panel-red">
                        <div class="panel-heading">
                           FORMULAIRE DE SUPPRESSION DE LIVRAISONS DE MEDICAMENTS FAIT AUX MALADES
                        </div>
							 ...
							 ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php 
													echo "<a href='rech_sortie_stock_malade_delete.php?id=".$row['IdSortieMedMal']."' title='Cliquez ici pour afficher les détails'>
							...
							<div class="panel panel-red">
								...
								?>							
									...
									<div class="col-lg-6">
										...
										<div class="form-group input-group">
											<span class="input-group-addon"><span class="glyphicon glyphicon-hand-right"></span></span>											
											<input type="text" class="form-control" name="QteLivreeMedMal" value="<?php echo $row['QteLivreeMedMal']; ?>" readonly>											
										</div>
										<label>Prix unitaire de livraison</label>
										<div class="form-group input-group">
											<span class="input-group-addon"><span class="glyphicon glyphicon-hand-right"></span></span>																				
											<input type="text" class="form-control" name="PrixUnitMedMal" value="<?php echo $row['PrixUnitMedMal']; ?>" readonly>											
										</div>
								<?php 
									}
								?>
	...
	if(isset($_POST['Supprimer'])){
		...
		$MotPasse=$_POST['MotPasse'];
			...
			if(mysql_num_rows($rqt)>0){
				...
				$Nvl=$rech['StockExistant'] + $QteLivreeMedMal;
				
					$req="DELETE FROM SortieMedMalades WHERE IdSortieMedMal='".$IdSortieMedMal."'";			
					...
					if (!$result){
						...
						echo "<div class='col-lg-6'><div class='alert alert-success alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
								<span class='glyphicon glyphicon-ok'></span> &nbsp; La livraison de medicament ".$DesignMedicament." au malade ".$Noms." a été supprimée avec succès. </div></div>";
					}

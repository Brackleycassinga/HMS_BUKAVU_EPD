	...
	<div class="row">
		<div class="col-lg-16">
			<h1 class="page-header" style="color:rgb(90, 100, 211);">
                   Gestion des Malades en ligne <small>: SUPPRESSION DES PRESCRIPTIONS</small> 
				  <img src="IMA/dep.jpg" width="120px" height="80px"/> <img src="IMA/error.png" width="120px" height="80px"/>
             </h1>
                    <div class="panel panel-red">
                        <div class="panel-heading">
                           RECHERCHE DE LA PRESCRIPTION DES EXAMENS A SUPPRIMER
                        </div>
								...
								<div class="col-lg-6">
									<div class="panel panel-red">
										<div class="panel-body">
											...
											<p align="justify"><strong>Vous pouvez seulement supprimer les prescriptions qui n'ont pas encore des resultats.
											Mais, si vous voulez supprimer une prescription ayant déjà des resultats; il va falloir d'abord annuler ses resultats.</strong></p>
										</div>												
									</div>
								</div>								
                            </div>
												...
												<tr>
													...
													<td><?php $search=mysql_query("SELECT * FROM ResultExamens WHERE ResultExamens.IdPrescription='".$row['IdPrescription']."'");
														if(mysql_num_rows($search)==0)
															echo "<a href='SuppPrescriptionExamens.php?id=".$row['IdPrescription']."' title='Cliquez ici pour afficher les détails'><span class='glyphicon glyphicon-list'></span> Afficher détail </a>";
														else
					...
					?>
						...
						<form action="supp_prescription_examens.php" method="GET" >
							<div class="panel panel-red">
								<div class="panel-body">
									<div class="col-lg-2">
								...
								?>							
										<label>Examen / Test N° <?php echo $i;?></label>
											<div class="form-group input-group"> 	
												...
												<select class="form-control" name="IdExamen<?php echo $i; ?>"  disabled >
								...
								?>
										...
										<div class="form-group input-group">
											...
											<center><button type="submit" class="btn btn-danger" name="SuppPrescription" onclick="return confirm('Voulez-vous vraiment supprimer définitivement ces examens prescrits ?');" ><span class="glyphicon glyphicon-trash"></span> Supprimer les données</button></center>
									</div>

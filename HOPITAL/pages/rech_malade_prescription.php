		...
		<div class="col-lg-16">
			<h1 class="page-header" style="color:rgb(90, 100, 211);">
                 Gestion des Malades en ligne <small>  : PRESCRIPTION DES EXAMENS / TESTS</small> 
				  <img src="IMA/rechdoc.png" width="120px" height="80px"/>
             </h1>
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                           RECHERCHE DU MALADE A PRESCRIRE LES EXAMENS
                        </div>
                            ...
                            <div class="row">                                
                                <div class="col-lg-6">
                                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
										...
										<label>Le Code ou Nom du Malade à prescrire les examens</label>
							 ...
							 ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo "<a href='rech_malade_prescription.php?id=".$row['Idauto_Patient']."' title='Confirmer si c'est bien le malade concerné'><span class='glyphicon glyphicon-ok'></span> Confirmer</a>";?></td>                                           
                                        </tr>                                      
			...
			<form action="AjoutPrescriptionExamens.php" method="GET" >
				<div class="panel panel-primary">
					<div class="panel-body">
						<div class="col-lg-4">					
						</div>					
						<div class="col-lg-4">					
							...
							<label>Veuillez Préciser le nombre d'exemen/test à passer</label>
                            <div class="form-group input-group"> 	
								<span class="input-group-addon"><span class="glyphicon glyphicon-file"></span></span> </span>                                           
								<input type="text" class="form-control" name="Nombre" placeholder="Nombre d'examen et/ou test à passer (En chiffre)" >
                            </div>
								<center><button type="submit" class="btn btn-primary" name="Continuer"><span class="glyphicon glyphicon-ok"></span> Confirmer et Passer à la prescription</button></center>
                        </div>										
					</div>					
				</div>										
			</form>

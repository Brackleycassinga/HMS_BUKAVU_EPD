	...
	<div class="row">
		<div class="col-lg-16">
			<h1 class="page-header" style="color:rgb(90, 100, 211);">
                 Gestion des Malades en ligne <small>  : SUPPRESSION DE SORTIES EN STOCK</small> 
				 <img src="IMA/medicaments.png" width="120px" height="80px" /><img src="IMA/error.png" width="120px" height="80px" />
             </h1>
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            RECHERCHE ET SUPPRESSION DE SORTIE EN STOCK DE MEDICAMENTS POUR LE SERVICE
                        </div>
								...
								<div class="panel panel-red">
									<div class="panel-body">
										<p> Un mot suffit pour votre recherche, vous pouvez saisir une partie ou l'appellation 
											complète du service bénéficiaire de la livraison de médicaments à supprimer.</p>
									</div>
							 ...
							 ?>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo "<a href='rech_sortie_stock_service_delete.php?id=".$row['IdSortieMedServ']."' title='Cliquez ici pour afficher le détail'><span class='glyphicon glyphicon-list'></span> Afficher</a>";?></td>                                           
                                        </tr>                                      
							...
							<?php
										...
										echo "<div class='col-lg-6'><div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
												<span class='glyphicon glyphicon-remove'></span>
													Aucune suggestion trouvée dans la liste de sorties en stock pour le service [$Mot], vérifiez-le et réessayer!!</div></div>";
									}
								}
							?>
					...
					?>
								...
								<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">                               
									...
									<div class="col-lg-4"> 
                                        ...
                                        <div class="form-group input-group">
											<span class="input-group-addon"><span class="glyphicon glyphicon-hand-right"></span></span>
												<select class="form-control" name="CodeService"  readonly >
                                        ...
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></span>
                                            <input type="text" class="form-control" name="QteDemandeMedServ" value="<?php echo $row['QteDemandeMedServ'];?>" readonly >
                                        </div>
										<label>Quantité livrée au service</label>
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></span>
                                            <input type="text" class="form-control" name="QteLivreeMedServ" value="<?php echo $row['QteLivreeMedServ'];?>" readonly >
                                        </div>
									</div>
									<div class="col-lg-4">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <input type="text" class="form-control" name="PrixUnitMedServ" value="<?php echo $row['PrixUnitMedServ'];?>" readonly >
                                        </div>	
										<label>Observation</label>
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"><span class="fa fa-file"></span></span>
                                            <input type="text" class="form-control" name="Observation" value="<?php echo $row['Observation'];?>" readonly >
                                        </div>	
									...
									<div class="col-lg-12">
                                            <center><button type="submit" class="btn btn-danger" name="Supprimer" onclick="return confirm('Etes-vous certain de supprimer définitivement cette livraison?');"><span class="glyphicon glyphicon-trash"></span> Supprimer la livraison </button></center>                                   									
									</div>
								</form>
	...
	if(isset($_POST['Supprimer'])){
		...
		$MotPasse=$_POST['MotPasse'];
			...
			if(mysql_num_rows($rqt)>0){
				...
				$Nvl=$rech['StockExistant'] + $QteLivreeMedServ;
			
					$req="DELETE FROM SortieMedServices WHERE IdSortieMedServ='".$IdSortieMedServ."'";			
					...
					if (!$result){
						...
						echo "<div class='col-lg-6'><div class='alert alert-success alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
								<span class='glyphicon glyphicon-ok'></span> &nbsp; La livraison de medicament ".$Designation." au service ".$CodeService." a été supprimée avec succès. </div></div>";
					}

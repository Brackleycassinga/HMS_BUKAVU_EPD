		...
		<div class="col-lg-16">
			<h1 class="page-header" style="color:rgb(90, 100, 211);">
                 Gestion des Malades en ligne <small>  : PRESCRIPTION DES MEDICAMENTS</small> 
				  <img src="IMA/medicaments.png" width="120px" height="80px"/> <img src="IMA/dep.jpg" width="120px" height="80px"/>
             </h1>
                    <div class="panel panel-green">
                        ...
                        <div class="panel-body">
							...
							?>
									...
									<form action="save_prescription_medicaments.php" method="GET" >
										<div class="col-lg-6">
										...
										<div class="col-lg-6">					
											...
											<label>Date de la prescription des médicaments </label>
											<div class="form-group input-group">
												<table>                                          
									...
									<div class="col-lg-12">
										...
										<div class="col-lg-4">
											<label>Sélectionnez le médicament N° <?php echo $i;?></label>
											<div class="form-group input-group"> 	
												<span class="input-group-addon"><span class="glyphicon glyphicon-hand-right"></span></span> </span>                                           
												<select class="form-control" name="IdMedicament<?php echo $i; ?>"  required >
										...
										<div class="col-lg-2">
											<label>Quantité N° <?php echo $i;?></label>
											<div class="form-group input-group">												
												<input type="text" class="form-control" name="Qte<?php echo $i; ?>" placeholder="Préciser le nombre" required>
											</div>
										</div>
										<div class="col-lg-6">
											<label>Mode de consommation du médicament prescrit</label>
											<div class="form-group input-group">
												<span class="input-group-addon"><span class="glyphicon glyphicon-hand-right"></span></span>
												<input type="text" class="form-control" name="Consommation<?php echo $i; ?>" placeholder="Mode de consommation" required>
											</div>
										</div>
								...
								<?php
										...
										header("location:rech_malade_presc_medicaments.php?id=".$Idauto_Patient."");
									}
								}
								else{
										header("location:rech_malade_presc_medicaments.php");
									}
								?>					
												
												<center><button type="submit" class="btn btn-success" name="EnregPrescription"><span class="glyphicon glyphicon-save"></span>Enregistrer la prescription des médicaments </button></center>
											</div>										
										</div>										
									</div>					
								</div>										

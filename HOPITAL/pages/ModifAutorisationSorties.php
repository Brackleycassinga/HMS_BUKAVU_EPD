	...
	<div class="row">
		<div class="col-lg-16">
			<h1 class="page-header" style="color:rgb(90, 100, 211);">
                 Gestion des Malades en ligne <small>  : MODIFICATION DE SORTIE</small> 
				  <img src="IMA/1.jpg" width="120px" height="80px"/><img src="IMA/ok.png" width="120px" height="80px"/>
             </h1>
                    <div class="panel panel-green">
                        <div class="panel-heading">
                           RECHERCHE DE L'AUTORISATION DE SORTIE A MODIFIER
                        </div>
								...
								<div class="panel panel-green">
									<div class="panel-body">
										<p> Un mot suffit pour votre recherche, vous pouvez saisir un code ou un 
											nom du malade concerné par la sortie à modifier.</p>
									</div>										
								</div>
                             </div>
                            </div>
							 ...
							 ?>				
											<tbody>
												<tr>
													...
													<td><?php echo "<a href='ModifAutorisationSorties.php?id=".$row['IdSortie']."' title='Cliquez ici pour commencer la modification'><span class='fa fa-list'></span> Modifier</a>";	?>
													</td>                                           
												</tr>                                      
											</tbody> 
							<?php
					...
					<div class="panel-body">
						...
						<div class="col-lg-6">
                            ...
                            <div class="form-group input-group"> 	
								...
								<input type="text" class="form-control" name="Etat" value="<?php echo $row['EtatSortie'];?>" placeholder="Etat constaté pour le malade" required>
                            </div>
							<label>Observation</label>
                            <div class="form-group input-group">						                                          
								<textarea class="form-control" name="Observation" style="width:590px" placeholder="Observation faite"><?php echo $row['Observation'];?></textarea>
                            </div>
						...
						<div class="col-lg-12">
								<center><button type="submit" class="btn btn-success" name="ModifSortie"><span class="glyphicon glyphicon-edit"></span> Modifier l'autorisation de sortie</button></center>
                        </div>										
					</div>					
				</div>										
			</form>
	...
	if(isset($_POST['ModifSortie'])){
		...
		$IdUtilisateur=$_SESSION['IdUtilisateur'];
			...
			if(mysql_num_rows($rqt)>0){
				$req="UPDATE Sorties SET EtatSortie='".$Etat."', Observation='".$Observation."' WHERE IdSortie='".$IdSortie."'";
				$result=mysql_query($req) or die(mysql_error());
					if (!$result){
						...
						echo "<div class='col-lg-6'><div class='alert alert-success alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
								<span class='glyphicon glyphicon-ok'></span> L'autorisation de sortie du malade ".$_POST['Noms']." a été modifiée avec succès </div></div>";
					}
			}
			else{
				echo "<div class='col-lg-6'><div class='alert alert-danger alert-dismissable'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
